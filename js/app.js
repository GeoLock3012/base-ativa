(function() {
        ...
        try { 
            ...
            if(toggle) { 
                ...
                toggle.addEventListener('change', (e) => { 
                    ...
                    if(cmEditor) cmEditor.setOption("theme", theme === 'dark' ? 'dracula' : 'default');
                }); 
            } 
        } catch(e) {} 
    }
    ...
    function bootSystem() {
        ...
        const checkLibs = setInterval(() => {
            if (typeof window.Chart !== 'undefined' && typeof window.jspdf !== 'undefined' && typeof window.XLSX !== 'undefined' && typeof window.CodeMirror !== 'undefined') {
